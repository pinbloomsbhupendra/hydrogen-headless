      ...
      <div className="w-full md:w-1/2 flex flex-col pt-2 md:pt-4">
        ...
        <ul className="w-full list-none p-0 m-0 flex flex-col gap-4 mb-0">
          ...
          <li className="flex items-center pb-2 border-b border-gray-100">
            ...
            <span className="text-base font-medium text-gray-600">Compact Size for Easy Storage</span>
          </li>
          <li className="flex items-center">
            <div className="product-bullet-number">3</div>
            <span className="text-base font-medium text-gray-600">Premium Security and Peace of Mind</span>
          </li>
        </ul>
