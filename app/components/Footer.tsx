                ...
                <div className="max-w-5xl mx-auto px-5 md:px-8 py-10 md:py-12 flex flex-col md:flex-row justify-between items-start gap-8 md:gap-4">
                    ...
                    <div className="flex-shrink-0">
                        <Link to="/" className="inline-block">
                            <img src="/Product/prolock-logo.png" alt="Prolock Logo" style={{ height: "48px", width: "auto" }} />
                        </Link>
                    </div>
                ...
                <div className="max-w-5xl mx-auto px-4 md:px-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <div className="order-1 md:order-3">
                        <div className="flex items-center cursor-pointer transition-all">
                            <img src="/logo/footer.png" alt="Footer Logo" className="h-5 md:h-15 w-25 object-contain" />
                        </div>
                    </div>
                </div>
            </div>
